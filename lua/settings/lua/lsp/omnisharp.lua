...
local get_root_dir = function(cwd)
	return util.root_pattern("*.slnx")(cwd)
		or util.root_pattern("*.sln")(cwd)
		or util.root_pattern("*.csproj")(cwd)
		or util.root_pattern("omnisharp.json")(cwd)
		or util.root_pattern("function.json")(cwd)
end
